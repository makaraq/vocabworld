          ...
          <div className="flex flex-col gap-3">
            {isIOS && (
              <Button
                ...
                className="w-full bg-black hover:bg-gray-900 text-white font-semibold py-5 px-6 rounded-xl transition-all duration-200 flex items-center justify-center gap-3 text-lg shadow-lg hover:shadow-xl transform hover:scale-105"
              >
            ...
            <Button
              ...
              disabled={loading || isSigningIn}
              className="w-full bg-white hover:bg-gray-50 text-gray-800 font-semibold py-5 px-6 rounded-xl transition-all duration-200 flex items-center justify-center gap-3 text-lg shadow-lg hover:shadow-xl transform hover:scale-105"
            >
