/**
 * Upload Bad Words Audio to Backblaze B2
 * Uploads 1,575 MP3 files to voco-audio-library2 bucket
 */
...
const AUDIO_DIR = 'scripts/bad-words-audio/BadWords';
const CSV_INPUT = 'scripts/bad-words-b2-urls-2026-02-11.csv';
const CSV_OUTPUT = 'scripts/bad-words-b2-urls-final.csv';
...
async function main() {
  console.log('📤 BAD WORDS B2 UPLOAD');
  ...
  console.log('\n📦 NEXT STEPS:');
  console.log('   1. Merge CSV into public/data/common-phrases-b2-urls.csv');
  console.log('   2. Test audio playback in app');
  console.log('\n🎉 Upload complete!');
}
