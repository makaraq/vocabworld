#!/usr/bin/env node
// Assembles the 'out/' static export directory from Next.js 16 build artifacts.
...
execSync('CAPACITOR_BUILD=true npx next build', { cwd: root, stdio: 'inherit', env: { ...process.env, CAPACITOR_BUILD: 'true' } })
