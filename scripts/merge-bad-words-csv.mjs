/**
 * Convert Bad Words CSV to common-phrases format and merge
 */

import fs from 'fs';

const inputFile = 'scripts/bad-words-b2-urls-final.csv';
const outputFile = 'public/data/common-phrases-b2-urls.csv';

console.log('📄 Converting Bad Words CSV format...\n');
...
for (const line of inputLines) {
  ...
  const entry = `"${filePath}","${b2Url}","${langCode}","BadWords","${filename}"`;
...
console.log('\n🎉 Bad Words audio ready to test in app!');
