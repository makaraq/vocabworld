/**
 * Generate Google TTS Audio - Bad Words (Topic 44)
 * 35 words × 47 languages = 1,645 MP3 files
...
const TOPIC_ID = 44;
const TOPIC_FOLDER = 'BadWords';
const OUTPUT_DIR = `scripts/bad-words-audio/${TOPIC_FOLDER}`;
...
async function main() {
  console.log('🎙️  BAD WORDS AUDIO GENERATION');
  ...
  const csvFilename = `scripts/bad-words-b2-urls-${timestamp}.csv`;
  ...
  console.log('\n📦 NEXT STEPS:');
  console.log('   1. Upload files to B2: scripts/bad-words-audio/');
